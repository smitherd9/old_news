...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAjax = __webpack_require__(5);
	...
	$(function () {
	    ...
	    function showNyTimes(results) {
	        ...
	        $.each(docs, function (index, currentObject) {
	            //index is just location of object in the array, value is the current object
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNyTimesByDate = function getNyTimesByDate(nyTimesDate) {
	    // var getNyTimesByDate (nyTimesDate) =>
	    var url = "https://api.nytimes.com/svc/search/v2/articlesearch.json";
	...
	var getNyTimesByDateRange = function getNyTimesByDateRange(nyTimesDate1, nyTimesDate2) {
	    var url = "https://api.nytimes.com/svc/search/v2/articlesearch.json";
	    $.ajax({
	        url: url,
	        type: 'GET',
	...
	var getNyTimesByTopic = function getNyTimesByTopic(byTopic, nyTimesDate) {
	    var url = "https://api.nytimes.com/svc/search/v2/articlesearch.json";
	    $.ajax({
	        url: url,
	        type: 'GET',
	...
	var getGuardianByDate = function getGuardianByDate(guardianDate) {
	    var url = 'http://content.guardianapis.com/search?';
	    $.ajax({
	        url: url,
	        type: 'GET',
	...
	var getGuardianByDateRange = function getGuardianByDateRange(guardianDate1, guardianDate2) {
	    var url = 'http://content.guardianapis.com/search?';
	    $.ajax({
	        url: url,
	        type: 'GET',
	...
	var getGuardianByTopic = function getGuardianByTopic(byTopic, guardianDate) {
	    var url = 'http://content.guardianapis.com/search?';
	    $.ajax({
	        url: url,
	        type: 'GET',
	...
	var getGuardianArticle = function getGuardianArticle(resultURL) {
	    var url = resultURL;
	    $.ajax({
	        url: url,
	        type: 'GET',
...
/***/ }
/******/ ]);
//# sourceMappingURL=old_news.1.0.0.js.map